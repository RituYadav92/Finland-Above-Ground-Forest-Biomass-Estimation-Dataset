## [BioMassters: A Benchmark Dataset for Forest Biomass Estimation using Multi-modal Satellite Time-series](https://openreview.net/pdf?id=hrWsIC4Cmz) (NeurIPS 2023)
